...
Config.EnemyModels = { "g_m_y_mexgoon_03", "g_m_m_chigoon_02", "g_m_y_salvagoon_03", "g_m_y_azteca_01" }
Config.EnemyVehicles = { "buccaneer", "ruiner", "dominator", "gauntlet", "vigero", "gresley" }
